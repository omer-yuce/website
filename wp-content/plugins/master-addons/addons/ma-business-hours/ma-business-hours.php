...
//                'full-bg-image',
	    ...
	    $ma_el_business_bg_image_url_src = Group_Control_Image_Size::get_attachment_image_src( $ma_el_business_bg_image['id'], $settings['ma_el_business_bg_img_size'], $settings );
	    ...
	    ?>
            <div <?php echo $this->get_render_attribute_string( 'ma_el_business_hours' ); ?>>
                ...
                <div class="ma-el-business-hour-content" <?php if ( $settings['ma_el_business_hours_style'] == 'content-bg-image' ) { echo 'style="background: url(' . $ma_el_business_bg_image_url_src . ') no-repeat center; background-size: cover;';}?>>
