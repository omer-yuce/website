...
class MA_Transform_Element extends Group_Control_Base {
    ...
    protected function init_fields() {
        ...
        $controls['transform'] = [
            'label' => _x( 'Transformations', 'Transform Control', MELA_TD ),
            'type' => 'transforms',
            'responsive' => true,
            'render_type' => 'ui',
            'condition' => [
        ...
        $controls['transform-origin'] = [
            'label' => _x( 'Transform origin', 'Transform-origin x/y Control', MELA_TD ),
            'type' => 'xy_positions',
            'responsive' => true,
            'render_type' => 'ui',
            'condition' => [
        ...
        $controls['perspective'] = [
            'label' => _x( 'Perspective', 'Perspective Control', MELA_TD ),
        ...
        $controls['perspective-origin'] = [
            'label' => _x( 'Perspective origin', 'Perspective-origin x/y Control', MELA_TD ),
            'type' => 'xy_positions',
            'responsive' => true,
            'condition' => [
                'transform_type' => 'custom',
