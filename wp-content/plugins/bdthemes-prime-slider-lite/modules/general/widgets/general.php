...
class General extends Widget_Base
{
    ...
    private function register_query_section_controls()
    {
        ...
        $this->add_control( 'slide_button_icon_background_hover_color', [
            'label'     => __( 'Icon Background', 'bdthemes-prime-slider' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
    ...
    public function rendar_item_youtube( $link )
    {
        ...
        ?>
			<iframe src="<?php 
        echo  esc_url( $url ) ;
        ?>" frameborder="0" allowfullscreen bdt-cover></iframe>
		<?php 
    }
    ...
    public function render_item_content( $slide_content )
    {
        ...
        if ( $slide_content['title'] && 'yes' == $settings['show_title'] ) {
            ...
            ?> class="bdt-title-tag" bdt-slideshow-parallax="x: 100,0,-20; opacity: 1,1,0">
									<?php 
