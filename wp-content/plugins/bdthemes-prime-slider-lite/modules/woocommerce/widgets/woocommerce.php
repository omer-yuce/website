	...
	private function register_query_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'(mobile){{WRAPPER}} .bdt-slideshow .bdt-overlay-default' => 'background-color: {{VALUE}};'
				]
			]
		);
	...
	public function render_item_content($product) {
		...
		<div class="bdt-ps-slideshow-content-wrapper">
			...
			<?php if ( $settings['show_title'] ) : ?>
				<<?php echo esc_html($settings['title_html_tag']); ?> class="bdt-ps-title" bdt-slideshow-parallax="y: 70,0,-100; opacity: 1,1,0"><?php the_title(); ?></<?php echo esc_html($settings['title_html_tag']); ?>>
			<?php endif; ?>
